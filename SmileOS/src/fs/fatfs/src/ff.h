...
FRESULT f_opendir (FATFS* fs, DIR* dj, const TCHAR* path);			/* Open an existing directory */
...
FRESULT f_getfree (FATFS* fs, const TCHAR* path, DWORD* nclst);	    /* Get number of free clusters on the drive */
FRESULT f_truncate (FIL* fp);										/* Truncate file */
FRESULT f_sync (FIL* fp);											/* Flush cached data of a writing file */
FRESULT f_unlink (FATFS* fs, const TCHAR* path);				    /* Delete an existing file or directory */
FRESULT	f_mkdir (FATFS* fs, const TCHAR* path);						/* Create a new directory */
FRESULT f_chmod (FATFS* fs, const TCHAR* path, BYTE value, BYTE mask);			/* Change attribute of the file/dir */
...
FRESULT f_mkfs (BYTE vol, FATFS* fs, BYTE sfd, UINT au);			/* Create a file system on the drive */
