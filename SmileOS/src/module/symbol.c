...
extern int  interrupt_mode_init(); 
...
SYMBOL_TABLE_BEGIN												
    ...
    SYMBOL_ITEM_FUNC(arch_in_kernel) 
    ...
    SYMBOL_ITEM_FUNC(interrupt_mode_init) 
    ...
    SYMBOL_ITEM_FUNC(soc_init) 
    SYMBOL_ITEM_FUNC(soc_timer_init) 
