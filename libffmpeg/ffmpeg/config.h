...
#define restrict                                                        /*  编译器不支持 restrict       */

#define MALLOC_PREFIX                                                   /*  内存分配函数前缀            */

#define HAVE_AV_CONFIG_H                                                /*  有 av_config.h 头文件       */
/********************************************* jiaojinxing **********************************************/
...
#define HAVE_FAST_UNALIGNED 0                                           /*  没有快速非对齐访问指令      */
/********************************************* jiaojinxing **********************************************/
...
/********************************************* jiaojinxing **********************************************/
/*
 * 使用 ffmpeg 内置的 llrint 与 llrintf 函数
 */
...
#define HAVE_MEMALIGN 0                                                 /*  没有 c-std 内存对齐分配函数 */
//#define HAVE_POSIX_MEMALIGN 1
#define HAVE_POSIX_MEMALIGN 0                                           /*  没有 posix 内存对齐分配函数 */
/********************************************* jiaojinxing **********************************************/
...
#define HAVE_STRUCT_IPV6_MREQ 0                                         /*  屏蔽掉 ipv6 部分代码        */
...
/********************************************* jiaojinxing **********************************************/
#define CONFIG_LIBOPENCORE_AMRNB 0                                      /*  加入 opencore-amr nb lib    */
#define CONFIG_LIBOPENCORE_AMRWB 0                                      /*  加入 opencore-amr wb lib    */

#define CONFIG_LIBOPENCORE_AMRNB_DECODER 0                              /*  使能 opencore-amr nb 解码器 */
#define CONFIG_LIBOPENCORE_AMRNB_ENCODER 0                              /*  使能 opencore-amr nb 编码器 */
#define CONFIG_LIBOPENCORE_AMRWB_DECODER 0                              /*  使能 opencore-amr wb 解码器 */

#define CONFIG_AMRNB_DECODER 0                                          /*  将 ffmpeg 内置的 amr 解码器 */
#define CONFIG_AMRWB_DECODER 0                                          /*  屏蔽掉, 使用 opencore-amr   */

#define CONFIG_LIBILBC 0                                                /*  加入 iLBC lib               */
#define CONFIG_LIBILBC_ILBC_DECODER 0                                   /*  使能 iLBC 解码器            */
#define CONFIG_LIBILBC_ILBC_ENCODER 0                                   /*  使能 iLBC 编码器            */
#define CONFIG_ILBC_DEMUXER 0                                           /*  使能 iLBC 解流器            */

#define CONFIG_LIBSPEEX 0                                               /*  加入 speex lib              */
#define CONFIG_LIBSPEEX_DECODER 0                                       /*  使能 SPEEX 解码器           */
#define CONFIG_LIBSPEEX_ENCODER 0                                       /*  使能 SPEEX 编码器           */
/********************************************* jiaojinxing **********************************************/
...
#define CONFIG_LIBRTMP 0                                                /*  加入 rtmp lib               */
