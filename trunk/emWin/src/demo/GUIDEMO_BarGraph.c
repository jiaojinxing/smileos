...
static void _DemoBarGraph(void) {
  ...
  yPosText = LOGO_DIST_BORDER + ((bmSeggerLogo70x35.YSize - GUI_GetFontSizeY()) >> 1);
  GUI_DispStringHCenterAt("emWin bargraph demo", (xSize + bmSeggerLogo70x35.XSize) >> 1, yPosText);
  //
