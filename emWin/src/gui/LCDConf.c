...
//
#define XSIZE_VIRT              lcd_info.var.xres_virtual
#define YSIZE_VIRT              lcd_info.var.yres_virtual
...
int LCD_X_DisplayDriver(unsigned LayerIndex, unsigned Cmd, void * pData) {
  ...
  case LCD_X_SETORG: {
    ...
    //...
    memcpy(&var, &lcd_info.var, sizeof(var));

    var.xoffset = p->xPos;
    var.yoffset = p->yPos;

    ioctl(lcd_info.fd, FBIOSET_VSCREENINFO, &var);
